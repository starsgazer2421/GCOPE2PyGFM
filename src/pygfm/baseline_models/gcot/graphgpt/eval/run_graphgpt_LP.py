...
def eval_model(args, prompt_file, start_idx, end_idx):
    ...
    #     print('meta')
    # Prefer encoder under ckpts/graphgpt/checkpoints unless overridden by CWD.
    enc_dir = os.environ.get("GRAPHGPT_GRAPH_ENCODER_DIR", "ckpts/graphgpt/checkpoints/clip_gt_arxiv")
    clip_graph, args_graph = load_model_pretrained(CLIP, enc_dir)
