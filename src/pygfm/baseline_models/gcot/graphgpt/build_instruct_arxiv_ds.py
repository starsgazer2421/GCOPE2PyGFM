...
def get_logger(fname,): 
    # 1. Get logger (logging entry point)
    ...
    # 6. Ready for logger.info(...)
    # logger.info('App started') 
    return logger
logger =  get_logger('process_train_arxiv')
# Global RNG seeds
th.manual_seed(0)
random.seed(123)  # fixed seed 123
instruct_list = {}
batch_id_list = [
     [0, 27560], 
     [27560, 42005], 
...
s = graph_data.edge_index.to_scipy()  # scipy sparse

edge_index, edge_attr = from_scipy_sparse_matrix(s)  # COO tensors
