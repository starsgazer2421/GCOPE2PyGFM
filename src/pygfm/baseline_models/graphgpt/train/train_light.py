...
from ..model.GraphLlama_pl import GraphGPT_pl
...
class TrainingArguments:
    ...
    output_dir: str = field(default="./ckpts/graphgpt/checkpoints/graphchat-gt-graphmatch-7b")
