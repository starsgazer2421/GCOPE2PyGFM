...
def eval_arxiv_nd(res_path):
    data=load_dataset_pt(dataset_rel("ogbn-arxiv", "processed_data.pt"))
...
def eval_products_nc(res_path):
    eval_set = set()
    data=load_dataset_pt(dataset_rel("ogbn-products", "processed_data.pt"))
...
def eval_pubmed_nc(res_path):
    data=load_dataset_pt(dataset_rel("pubmed", "processed_data.pt"))
    labels=data.label_texts
...
def eval_cora_nc(res_path):
    data=load_dataset_pt(dataset_rel("cora", "processed_data.pt"))
    labels=data.label_texts
