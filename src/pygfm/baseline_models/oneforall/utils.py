...
# Set before transformers/hf_hub; override HF_ENDPOINT
...
from pygfm.baseline_models.oneforall.models.model import LLMModel
os.environ["TOKENIZERS_PARALLELISM"] = "false"

class SentenceEncoder:
    def __init__(self, llm_name, cache_dir=None, batch_size=1, multi_gpu=False):
    ...
    def encode(self, texts, to_tensor=True):
        ...
        with torch.no_grad():
            for start_index in trange(0, len(texts), self.batch_size, desc="Batches", disable=False, ):
                ...
                # HF BatchEncoding has .to; stub llm_name returns plain dict tokenizer
                if hasattr(text_tokens, "to") and not isinstance(text_tokens, dict):
