#!/usr/bin/env python
"""Generate GraphKeeper downstream few-shot splits (default downstream_data/graphkeeper)."""
...
def _parse():
    p = argparse.ArgumentParser(description="Generate GraphKeeper downstream splits")
