...
# -*- coding: utf-8 -*-
"""
Generate GraphPrompt downstream few-shot splits.

Usage:
  python scripts/graphprompt/generate_downstream.py few_shot --dataset Cora --k_shot 5
  python scripts/graphprompt/generate_downstream.py graph_batch --dataset Cora --k_shot 1
"""
...
def _parse():
    p = argparse.ArgumentParser(description="Generate GraphPrompt downstream few-shot data")
    p.add_argument("mode", choices=["few_shot", "graph_batch"], help="Generation mode")
