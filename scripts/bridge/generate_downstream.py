#!/usr/bin/env python
"""
Generate BRIDGE downstream few-shot splits (same format as MDGPT; default under downstream_data/bridge).

  python scripts/bridge/generate_downstream.py few_shot --dataset Cora --k_shot 1
  python scripts/bridge/generate_downstream.py graph_batch --dataset Cora --k_shot 1
"""
...
def _parse():
    p = argparse.ArgumentParser(description="Generate BRIDGE downstream splits")
