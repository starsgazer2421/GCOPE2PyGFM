#!/usr/bin/env python
"""
Generate SAMGPT downstream few-shot splits (same format as MDGPT; default under downstream_data/samgpt).

  python scripts/samgpt/generate_downstream.py few_shot --dataset Cora --k_shot 1
  python scripts/samgpt/generate_downstream.py graph_batch --dataset Cora --k_shot 1
"""
...
def _parse():
    p = argparse.ArgumentParser(description="Generate SAMGPT downstream splits")
