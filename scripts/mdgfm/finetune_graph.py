#!/usr/bin/env python
"""
MDGFM DownPrompt few-shot graph classification; reuses MDGPT graph_batch split paths.
"""
...
def main():
    ...
    pretext_weights, sumtext_weight = preprompt.get_weights()
    ...
    for sid in split_ids:
        ...
        print(f">> MDGFM Finetune graph {args.dataset} | {args.k_shot}-shot | split {sid} | support_graphs={num_support_graphs}, test_graphs={len(test_indices)}")
